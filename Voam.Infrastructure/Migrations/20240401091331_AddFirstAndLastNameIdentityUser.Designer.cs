...
namespace Voam.Server.Migrations
{
    ...
    [Migration("20240401091331_AddFirstAndLastNameIdentityUser")]
    partial class AddFirstAndLastNameIdentityUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voam.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Voam.Infrastructure.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Voam.Infrastructure.Data.Models.Order", b =>
                {
                    b.HasOne("Voam.Infrastructure.Data.Models.ApplicationUser", "Customer")
                        .WithMany()
